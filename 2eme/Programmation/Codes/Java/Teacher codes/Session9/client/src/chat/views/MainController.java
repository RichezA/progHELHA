...
public class MainController {
    ...
    public void showChangePseudo(String oldPseudo, String newPseudo) {
        messagesBox.getChildren().add(new Label(oldPseudo + " s'appelle désormais " + newPseudo));
    }

    public void showByeBye(User user) {
        messagesBox.getChildren().add(new Label(user.getName() + " a quitté le chat"));
    }
