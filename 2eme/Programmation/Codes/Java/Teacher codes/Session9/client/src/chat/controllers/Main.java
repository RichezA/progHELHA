...
public class Main extends Application {
    ...
    private void startClient(MainController mainController, User user) throws IOException {
        client = new Client(user, new Client.Interaction() {
            ...
            @Override
            public void onChangePseudo(String oldPseudo, String newPseudo) {
                Platform.runLater(() -> mainController.showChangePseudo(oldPseudo, newPseudo));
            }

            @Override
            public void onByeBye(User user) {
                Platform.runLater(() -> mainController.showByeBye(user));
            }
        });
        client.start();
    }
