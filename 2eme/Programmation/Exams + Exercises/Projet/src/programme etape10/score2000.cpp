...
#pragma region Variables
    ...
    int exit = 0;
    std::string data = "\n";
    std::string selectNbGagnant = "SELECT Joueur.idJoueur, COUNT(Joueur.aGagne) as 'Nbre de parties gagnées' FROM Joueur WHERE Joueur.aGagne = 1 GROUP BY Joueur.NomJoueur";
